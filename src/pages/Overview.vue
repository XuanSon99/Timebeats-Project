      ...
      <div class="row">
        <div class="col-xl-3 col-md-6">
          <stats-card>
            <div slot="header" class="icon-success">
              <i
                class="nc-icon nc-circle-09 text-success"
        ...
        <div class="col-xl-3 col-md-6">
          <stats-card>
            <div slot="header" class="icon-success">
              <i
                class="nc-icon nc-paper-2 text-primary"
                style="font-size: 60px"
              ></i>
            </div>
            <div slot="content">
              <p class="card-category">Tổng chiến dịch</p>
        ...
        <div class="col-xl-3 col-md-6">
          <stats-card>
            ...
            <div slot="content">
              <p class="card-category">Số câu hỏi</p>
        ...
        <div class="col-xl-3 col-md-6">
          <stats-card>
            <div slot="header" class="icon-info">
              <i
                class="nc-icon nc-notes text-danger"
                style="font-size: 60px"
              ></i>
            </div>
            <div slot="content">
              <p class="card-category">Cần xét duyệt</p>
