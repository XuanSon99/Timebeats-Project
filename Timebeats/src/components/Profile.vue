									...
									<ul class="nav nav-tabs profile navtab-custom panel-tabs">
										<li class="">
											<a href="#profile" class="active" data-toggle="tab" aria-expanded="false">
												<span class="visible-xs"><i class="fas fa-address-card"></i></span>
												<span class="hidden-xs">THÔNG TIN CÁ NHÂN</span> </a>
										</li>
										<li class="">
											<a href="#accuracy" data-toggle="tab" aria-expanded="false" class=""> <span class="visible-xs"><i class="fas fa-user-lock"></i></span>
												<span class="hidden-xs">XÁC THỰC HAI LỚP</span> </a>
										</li>
										<li class="">
											<a href="#settings" data-toggle="tab" aria-expanded="false" class=""> <span class="visible-xs"><i class="fas fa-key"></i></span>
												<span class="hidden-xs">ĐỔI MẬT KHẨU</span> </a>
										</li>
									</ul>
								</div>
								<div class="tab-content border-left border-bottom border-right border-top-0 p-4">
									<div class="tab-pane active" id="profile">
										...
										<div class="card card-body pd-20 pd-md-40 border shadow-none">
											<form class="form-horizontal" enctype="multipart/form-data" id="myProfile" method="post" action="https://timebeats.com/dashboard/profile">
												<input type="hidden" name="_token" value="9CRxmKLNzjSPgU2OMwZGPGlU7RxqFNbzOhafUgRJ">
												<div class="form-group ">
													<div class="row">

														<div class="col-md-12">
															<div class="main-img-user profile-user" style="width: 120px; height: 120px; margin-bottom: 20px">
																<img alt="" src="../assets/vendor/img/photos/user.png" id="profileImg"><a class="fas fa-camera profile-edit" href="JavaScript:void(0);"></a>
																<input type="file" id="inputImg" name="avatar" style="display: none;">
															</div>
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row">
														...
														<div class="col-md-12">
															<input type="text" class="form-control" name="full_name" placeholder="Họ Và Tên" value="">
														</div>
														...
														<div class="col-md-12">
															<div class="row row-sm mg-b-20">
																<div class="input-group col-md-4">
																	...
																	<input class="form-control fc-datepicker birthdate" value="01-01-1970" name="birthday" placeholder="DD-MM-YYYY" type="text">
																	<p style="display: none" class="alert alert-danger msg-birthday">Vui lòng
																		nhập đúng định dạng. Ví dụ: 12-12-2002</p>
																</div>
															</div><!-- wd-200 -->
														</div>
													</div>
												...
												<div class="form-group ">
													<div class="row">
														...
														<div class="col-md-12">
															<input type="text" class="form-control" name="address1" placeholder="Địa chỉ" value="">
														</div>
													</div>
												</div>
													...
													<div class="row">
														...
														<div class="col-md-12">
															<select name="city" class="form-control select2">
																...
																<option value="Thành phố Hải Phòng">Thành phố Hải Phòng
																</option>
																...
																<option value="Tỉnh Thừa Thiên Huế">Tỉnh Thừa Thiên Huế
																</option>
																...
																<option value="Tỉnh Bà Rịa - Vũng Tàu">Tỉnh Bà Rịa - Vũng
																	Tàu</option>
												...
												<div class="form-group ">
													<div class="row">
														<div class="col-md-12">
															<input type="text" class="form-control" name="email" placeholder="example@gmail.com" value="">
														</div>
									...
									<div class="tab-pane" id="settings">
										...
										<div class="card card-body pd-20 pd-md-40 border shadow-none">
											<form class="form-horizontal" role="form" method="post" action="/change_password">
												<input type="hidden" name="_token" value="9CRxmKLNzjSPgU2OMwZGPGlU7RxqFNbzOhafUgRJ">
												<div class="form-group">
													<input type="password" name="old_password" class="form-control" id="inputOldPass" placeholder="Mật khẩu hiện tại" required="">
												</div>
												<div class="form-group">
													<input type="password" pattern=".{6,}" id="password" name="new_password" class="form-control" placeholder="Mật khẩu mới" required="">
												</div>
												<div class="form-group">
