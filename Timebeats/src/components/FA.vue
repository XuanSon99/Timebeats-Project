      ...
      <div class="main-content horizontal-content">
			...
			<div class="container">
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">CÀI ĐẶT XÁC THỰC HAI LỚP</h4>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
					...
					<div class="col-lg-12 col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<p class="mg-b-20">Để bắt đầu sử dụng, <br>
									Xin hãy sử dụng điện thoại của bạn để Scan mã QR dưới đây. Ví dụ: sử dụng ứng dụng
									Google Authenticator <br>
									Sau đó, nhập mã xác minh được tạo từ ứng dụng.</p>
								<div class="row">
